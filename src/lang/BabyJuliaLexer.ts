...
export class BabyJuliaLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(BabyJuliaLexer._LITERAL_NAMES, BabyJuliaLexer._SYMBOLIC_NAMES, []);
	...
	// @Override
	public get ruleNames(): string[] { return BabyJuliaLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return BabyJuliaLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return BabyJuliaLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return BabyJuliaLexer.modeNames; }
	...
	public static get _ATN(): ATN {
		if (!BabyJuliaLexer.__ATN) {
			BabyJuliaLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(BabyJuliaLexer._serializedATN));
		}
