...
export class BabyJuliaParser extends Parser {
  ...
  public static readonly ruleNames: string[] = ["prog", "expr", "atom"];
  ...
  public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(
    BabyJuliaParser._LITERAL_NAMES,
    BabyJuliaParser._SYMBOLIC_NAMES,
    []
  );
  ...
  public get ruleNames(): string[] {
    return BabyJuliaParser.ruleNames;
  }

  // @Override
  public get serializedATN(): string {
    return BabyJuliaParser._serializedATN;
  }
  ...
  public prog(): ProgContext {
    ...
    this.enterRule(_localctx, 0, BabyJuliaParser.RULE_prog);
    let _la: number;
    try {
      let _alt: number;
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        while (
          (_la & ~0x1f) === 0 &&
          ((1 << _la) &
            ((1 << BabyJuliaParser.NUMBER) |
              (1 << BabyJuliaParser.STRING) |
              (1 << BabyJuliaParser.BOOL) |
              (1 << BabyJuliaParser.NAME) |
              (1 << BabyJuliaParser.NEWLINE))) !==
            0
        ) {
          {
            this.state = 14;
    ...
    try {
      ...
      switch (this._input.LA(1)) {
        case BabyJuliaParser.NAME:
          ...
          {
            this.state = 21;
            (_localctx as VarDeclarationContext)._name = this.match(
              BabyJuliaParser.NAME
            );
            this.state = 22;
  ...
  public static readonly _serializedATN: string =
    ...
    "\x02\x03\x02\x03\x03\x03\x03\x03\x03\x03\x03\x05\x03\x1C\n\x03\x03\x04" +
    "\x03\x04\x03\x04\x02\x02\x02\x05\x02\x02\x04\x02\x06\x02\x02\x03\x03\x02" +
    "\x03\x05\x02 \x02\x12\x03\x02\x02\x02\x04\x1B\x03\x02\x02\x02\x06\x1D" +
    "\x03\x02\x02\x02\b\f\x05\x04\x03\x02\t\v\x07\r\x02\x02\n\t\x03\x02\x02" +
    "\x02\v\x0E\x03\x02\x02\x02\f\n\x03\x02\x02\x02\f\r\x03\x02\x02\x02\r\x11" +
    "\x03\x02\x02\x02\x0E\f\x03\x02\x02\x02\x0F\x11\x07\r\x02\x02\x10\b\x03" +
    "\x02\x02\x02\x10\x0F\x03\x02\x02\x02\x11\x14\x03\x02\x02\x02\x12\x10\x03" +
    "\x02\x02\x02\x12\x13\x03\x02\x02\x02\x13\x15\x03\x02\x02\x02\x14\x12\x03" +
    "\x02\x02\x02\x15\x16\x07\x02\x02\x03\x16\x03\x03\x02\x02\x02\x17\x18\x07" +
    "\v\x02\x02\x18\x19\x07\x0E\x02\x02\x19\x1C\x05\x06\x04\x02\x1A\x1C\x05" +
    "\x06\x04\x02\x1B\x17\x03\x02\x02\x02\x1B\x1A\x03\x02\x02\x02\x1C\x05\x03" +
    "\x02\x02\x02\x1D\x1E\t\x02\x02\x02\x1E\x07\x03\x02\x02\x02\x06\f\x10\x12" +
    "\x1B";
  public static __ATN: ATN;
  public static get _ATN(): ATN {
    if (!BabyJuliaParser.__ATN) {
      BabyJuliaParser.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(BabyJuliaParser._serializedATN)
      );
    }
...
export class ProgContext extends ParserRuleContext {
  public EOF(): TerminalNode {
    return this.getToken(BabyJuliaParser.EOF, 0);
  }
  public expr(): ExprContext[];
  ...
  public get ruleIndex(): number {
    return BabyJuliaParser.RULE_prog;
  }
  // @Override
...
export class ExprContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return BabyJuliaParser.RULE_expr;
  }
...
export class VarDeclarationContext extends ExprContext {
  ...
  public ASSIGN(): TerminalNode {
    return this.getToken(BabyJuliaParser.ASSIGN, 0);
  }
  public NAME(): TerminalNode {
    return this.getToken(BabyJuliaParser.NAME, 0);
  }
  public atom(): AtomContext {
...
export class AtomContext extends ParserRuleContext {
  public NUMBER(): TerminalNode | undefined {
    return this.tryGetToken(BabyJuliaParser.NUMBER, 0);
  }
  public STRING(): TerminalNode | undefined {
    return this.tryGetToken(BabyJuliaParser.STRING, 0);
  }
  public BOOL(): TerminalNode | undefined {
    return this.tryGetToken(BabyJuliaParser.BOOL, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return BabyJuliaParser.RULE_atom;
  }
  // @Override
  public enterRule(listener: BabyJuliaListener): void {
